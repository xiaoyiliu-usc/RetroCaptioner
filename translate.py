...
parser.add_argument('--checkpoint_dir', type=str, default='checkpoint_aug10_pretrained',
...
parser.add_argument('--checkpoint', type=str, default='a_model_1240000.pt', help='checkpoint model file')

...
parser.add_argument('--batch_size_trn', type=int, default=12, help='raw train batch size')
parser.add_argument('--batch_size_val', type=int, default=12, help='val/test batch size')
...
parser.add_argument('--intermediate_dir', type=str, default='intermediate_aug5', help='intermediate directory')

parser.add_argument('--checkpoint_dir', type=str, default='used3d_checkpoint_aug5_pretrained',
...
def main(args):
    ...
    criterion_tokens = LabelSmoothingLoss(ignore_index=model.module.embedding_tgt.word_padding_idx,
                ...
                if args.local_rank == 0:
                    ...
                    if global_step % args.val_per_step == 0:
                        accuracy_arc, accuracy_brc, accuracy_token = \
                            validate(args, model, val_iter, model.module.embedding_tgt.word_padding_idx)
